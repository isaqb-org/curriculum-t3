...
image:https://img.shields.io/github/commits-since/isaqb-org/curriculum-t3/latest.svg[]
|===
| Version | HTML | PDF
...
- link:https://github.com/isaqb-org/curriculum-t3/blob/main/CHANGELOG.md[CHANGELOG.md on GitHub]
