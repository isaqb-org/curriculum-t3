...
1. Sie möchten an einem Certified Professional for Software Architecture Train-the-Trainer-Training teilnehmen.
...
1. You wish to participate in a CPSA Certified Professional for Software Architecture Train-the-Trainer training.
For this purpose, it shall be permitted to use these text documents and/or curricula by creating working copies for your own computer. If any other use of documents and/or curricula is intended, for instance for their dissemination to third parties, for advertising etc., please write to info@isaqb.org to enquire whether this is permitted. A separate license agreement would then have to be entered into.
