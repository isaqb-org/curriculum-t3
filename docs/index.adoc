...
The terminology used in the iSAQB^®^ curricula can be found as a (freely available) ebook, published on https://leanpub.com/iSAQB^®^glossary/read[Leanpub].

== Latest Release {release-version}

The {curriculum-short} curriculum is currently maintained and published in English (EN) only.
