...
The iSAQB^®^ curricula describe training prerequisites and learning goals, but they don't describe how to deliver a training that is able to meet the needs and expectations of training participants.
