...
T3P can break down learning content along the didactic path into modular units with clearly delineated learning objectives and appropriate granularity.
