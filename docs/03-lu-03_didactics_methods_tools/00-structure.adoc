// header file for curriculum section 3: Didactics, Methods, Tools and Best Practices
...
// tag::EN[]
|===
| Training duration: 180-360 min (recom.: 300 min) | Practice time: 20-50% of duration
|===
// end::EN[]
